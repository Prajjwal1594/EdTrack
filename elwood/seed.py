...
def seed():
    ...
    with app.app_context():
        ...
        sections1, subjects1, terms1, active_term1, fee_types1 = seed_school_data(school1, admin1, teachers1)
        ...
        sections2, subjects2, terms2, active_term2, fee_types2 = seed_school_data(school2, admin2, teachers2, term_offset_months=2)
