...
def manage(section_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Check for overlaps for the same Section, Teacher, or Room
            ...
            if collision:
                conflict_reason = "Section" if collision.section_id == int(section_id) else "Teacher" if collision.teacher_id == int(teacher_id) else "Room"
