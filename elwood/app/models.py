...
class Student(db.Model):
    ...
    alternate_class_group = db.Column(db.String(20))
    class_group = db.Column(db.String(20))
...
class Announcement(db.Model):
    ...
    school = db.relationship('School', backref=db.backref('announcements', lazy='dynamic'))
    creator = db.relationship('User', foreign_keys=[created_by])
...
class Event(db.Model):
    ...
    school = db.relationship('School', backref=db.backref('events', lazy='dynamic'))
    creator = db.relationship('User', foreign_keys=[created_by])
...
class FinancialLedger(db.Model):
    """General unified school ledger for income/expense outside of student fees."""
